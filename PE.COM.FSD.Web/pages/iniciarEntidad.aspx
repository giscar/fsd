                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtLatitud" runat="server" autocomplete="off" maxlength="80" placeholder="Ingrese Latitud" />
                                            <small class="form-text text-muted">Ingrese la Latitud</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtLongitud">Longitud</label>
                                            <input type="text" class="form-control" id="txtLongitud" runat="server" autocomplete="off" maxlength="80" placeholder="Ingrese Longitud" />
                                            <small class="form-text text-muted">Ingrese la Longitud</small>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="txtLatitudEditar" runat="server" autocomplete="off" maxlength="80" placeholder="Ingrese Latitud" />
                                                    <small class="form-text text-muted">Ingrese la Latitud</small>
                                                </div>
                                                <div class="form-group">
                                                    <label for="txtLongitudEditar">Longitud</label>
                                                    <input type="text" class="form-control" id="txtLongitudEditar" runat="server" autocomplete="off" maxlength="80" placeholder="Ingrese Longitud" />
                                                    <small class="form-text text-muted">Ingrese la Longitud</small>
                                                </div>
                                                <div class="form-group">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="GridView2" runat="server" AllowPaging="true" OnPageIndexChanging="GridView2_PageIndexChanging"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ShowHeader="true" HeaderText="Oficinas" ItemStyle-Width="10%">
                                            <ItemTemplate>
                                                ...
                                                <p><asp:LinkButton ID="linkbtn" runat="server" CssClass="btn btn-success" CommandArgument='<%# Eval("IdTipo") %>' CommandName="btn_clck">Listar</asp:LinkButton></p>
                                                <p><a id="link_agregar" onclick="agregarAgencia('<%# Eval("IdTipo") %>','<%# Eval("DesTipo") %>')" class="btn btn-success" />Agregar</a></p>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
