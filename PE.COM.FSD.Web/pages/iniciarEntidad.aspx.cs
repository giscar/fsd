        ...
        */
        ...
        protected void Submit_modificar_entidad(object sender, EventArgs e)
        {
            try
            {
                ...
                sb.Append(@"</script>");
                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "sasd", sb.ToString(), false);
        ...
        protected void Submit_nuevo_agencia(object sender, EventArgs e)
        {
            ...
            {
                IdTipo = int.Parse(hdEntidadAgenciaSel.Value),
        ...
        protected void gridOficinas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "btn_editar")
            {
                cargarCombosEditar();
                // datos de la entidad
                hdEntidadAgenciaSel.Value = Convert.ToString(entidad.IdTipo);
                txtEntidadEditar.Value = entidad.DesTipo;
                txtRUCEditar.Value = entidad.CodRuc;
                txtDireccionEditar.Value = entidad.Direccion;
                txtCodigoPostalEditar.Value = entidad.CodigoPostal;
                txtLatitudEditar.Value = entidad.Latitud;
                txtLongitudEditar.Value = entidad.Longitud;
        ...
        //    comunicacion.CorreoUsuario = "gerardois@hotmail.com";
